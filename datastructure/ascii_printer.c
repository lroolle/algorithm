...
int main() {
  ...
  root = insert(1111, root);
  /* print_ascii_tree(root); */

  printf("Print \n\n");
  Tree *noleft;
  noleft = malloc(sizeof(noleft));
  make_empty(noleft);
  noleft->element = 1;
  ...
  noleft->right = root;
  print_ascii_tree(noleft);
  /* printf("\nAfter inserting element 15..\n"); */
  root = insert(111111, root);
  /* print_ascii_tree(root); */
  ...
  /* root = insert(112, root); */
  root = insert(11111, root);
  root = insert(1111111, root);
  print_ascii_tree(root);
  ...
  /* printf("\n\nAfter deleting a node (10, root node) with left and right " */
  /*        "children..\n"); */
  /* root = delete (10, root); */
  /* print_ascii_tree(root); */

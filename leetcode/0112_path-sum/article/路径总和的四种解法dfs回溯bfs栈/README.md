"+++
title = "0112. Path Sum 路径总和的四种解法：DFS、回溯、BFS、栈 "
author = ["fuxuemingzhu"]
date = 2020-07-07T02:05:41+08:00
tags = ["Leetcode", "Algorithms", "BreadthfirstSearch", "DepthfirstSearch", "Backtracking", "Queue", "Stack", "Python", "Python3", "Java"]
categories = ["leetcode"]
draft = false
+++
...
> [路径总和的四种解法：DFS、回溯、BFS、栈](https://leetcode-cn.com/problems/path-sum/solution/lu-jing-zong-he-de-si-chong-jie-fa-dfs-hui-su-bfs-/) by [fuxuemingzhu](https://leetcode-cn.com/u/fuxuemingzhu/)

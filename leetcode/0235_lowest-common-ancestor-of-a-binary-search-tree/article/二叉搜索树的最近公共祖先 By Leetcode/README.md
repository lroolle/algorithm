"+++
title = "0235. Lowest Common Ancestor of a Binary Search Tree 二叉搜索树的最近公共祖先 "
author = ["LeetCode-Solution"]
date = 2020-09-26T15:52:19+08:00
tags = ["Leetcode", "Algorithms", "C", "C++", "Go", "Java", "Python", "Tree", "BinarySearchTree"]
categories = ["leetcode"]
draft = false
+++
...
> [二叉搜索树的最近公共祖先](https://leetcode-cn.com/problems/lowest-common-ancestor-of-a-binary-search-tree/solution/er-cha-sou-suo-shu-de-zui-jin-gong-gong-zu-xian-26/) by [LeetCode-Solution](https://leetcode-cn.com/u/leetcode-solution/)

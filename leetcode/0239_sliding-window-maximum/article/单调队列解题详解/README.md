"+++
title = "0239. Sliding Window Maximum 单调队列解题详解 "
author = ["labuladong"]
date = 2019-06-14T07:27:42+08:00
tags = ["Leetcode", "Algorithms", "SlidingWindow", "C++"]
categories = ["leetcode"]
draft = false
+++
...
> [单调队列解题详解](https://leetcode-cn.com/problems/sliding-window-maximum/solution/dan-diao-dui-lie-by-labuladong/) by [labuladong](https://leetcode-cn.com/u/labuladong/)
### 一、搭建解题框架

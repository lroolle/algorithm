"+++
title = "0530. Minimum Absolute Difference in BST 二叉搜索树的最小绝对差 "
author = ["LeetCode-Solution"]
date = 2020-10-11T15:23:13+08:00
tags = ["Leetcode", "Algorithms", "C", "C++", "Go", "Java", "JavaScript", "BinarySearchTree"]
categories = ["leetcode"]
draft = false
+++
...
> [二叉搜索树的最小绝对差](https://leetcode-cn.com/problems/minimum-absolute-difference-in-bst/solution/er-cha-sou-suo-shu-de-zui-xiao-jue-dui-chai-by-lee/) by [LeetCode-Solution](https://leetcode-cn.com/u/leetcode-solution/)

"+++
title = "0047. Permutations II 回溯搜索 + 剪枝（Java、Python） "
author = ["liweiwei1419"]
date = 2019-06-20T11:18:47+08:00
tags = ["Leetcode", "Algorithms", "Backtracking", "Java", "Python3"]
categories = ["leetcode"]
draft = false
+++
...
> [回溯搜索 + 剪枝（Java、Python）](https://leetcode-cn.com/problems/permutations-ii/solution/hui-su-suan-fa-python-dai-ma-java-dai-ma-by-liwe-2/) by [liweiwei1419](https://leetcode-cn.com/u/liweiwei1419/)
